{
   ...
   "data": {
      ...
      "results": [
        ...
        "payload": "GET wss://d1b99v8obmws9f.cloudfront.net/ HTTP/1.1[crlf]Host: planos3-assine-empresas.clarobrasil.mobi[crlf]Upgrade: Websocket[crlf]Connection: Upgrade[crlf][crlf]",
        "status": "ACTIVE",
    ...
    },
    {
        ...
        "v2ray_uuid": "",
        "primary_dns_server": "8.8.8.8",
        "payload": "wss://d1b99v8obmws9f.cloudfront.net/ HTTP/1.1[crlf]Host: planos3-assine-empresas.clarobrasil.mobi[crlf]Upgrade: Websocket[crlf]Connection: Upgrade[crlf][crlf]",
        "status": "DELETED",
        "secondary_dns_server": "8.8.4.4",
        "sni": "planos3-assine-empresas.clarobrasil.mobi",
    ...
    },
    {
        ...
        "v2ray_uuid": "",
        "primary_dns_server": "8.8.8.8",
        "payload": "GET / HTTP/1.1[crlf]Host: ascnet.ascnet.tk[crlf]Upgrade: Websocket[crlf][crlf]",
        "status": "ACTIVE",
        "secondary_dns_server": "8.8.4.4",
        "sni": "recarga.vivo.com.br",
        "config_mode": "ssh_proxy",
